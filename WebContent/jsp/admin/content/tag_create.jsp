					...
					<div class="panel panel-default">
						<div class="panel-body">
                           ...
                           <div class="well">
 							...
 							<form action="tag_create" class="form-horizontal" role="form" method="Post" name="form" id="form">
	                             <div class="input-group" >
	                                 <input type="text" class="form-control" size=100 name="name" placeholder="键入标签名">
	                                 
	                                 
	                             </div>
	                             <div class="input-group">
	                             	<input type="text" class="form-control" name="description" placeholder="键入标签描述">

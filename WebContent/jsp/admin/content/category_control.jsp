                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${ categorys }" var="category" varStatus="itemStatus">
                                	<tr>
                                		...
                                		<td><a href="${pageContext.request.contextPath}/jsp/admin/content/category_update?id=${ category.id }">编辑</a>
                                			/<a href="${pageContext.request.contextPath}/jsp/admin/content/category_delete?id=${ category.id }">删除</a>
                                		</td>
                                		<td><a href="#">查看</a></td>
                                	</tr>
                                </c:forEach>

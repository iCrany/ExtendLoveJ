					...
					<div class="panel panel-default">
						<div class="panel-body">
                           ...
                           <div class="well">
 							...
 							<form action="category_update" class="form-horizontal" role="form" method="Post" name="form" id="form">
	                             <div class="input-group" >
	                                 <input type="text" class="form-control" name="name" placeholder="键入新分类名">
	                             </div>
	                             <div class="input-group">
	                             	<input type="text" class="form-control" name="description" placeholder="键入新分类描述">
	                             ...
	                             <input type="hidden" name="trash" value="${ category.trash }">                            
